...
<script>
import featuredImg01 from '~/assets/images/banner/banner01.png'
import featuredImg02 from '~/assets/images/banner/banner02.jpg'
import featuredImg03 from '~/assets/images/banner/banner03.png'
import featuredImg04 from '~/assets/images/banner/banner04.jpg'
export default {
  name: "",
  props: {
    initialSpeed: {
